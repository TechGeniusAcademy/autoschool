            ...
            {loading ? (
              ...
              <div className="text-center py-12">
                ...
                <p className="text-xs text-gray-400 mt-2">
                  Loading: {loading.toString()}, Reviews count: {reviews.length}
                </p>
              </div>
            ) : (
                ...
                {({ values, setFieldValue }) => (
                  <Form className="space-y-6">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                      ...
                      <div>
                        <label className="block text-sm font-medium text-gray-700 mb-2">Причина отзыва</label>
                        <Field as="select" name="reason" className="w-full border border-gray-300 rounded-lg px-4 py-3 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent">
                          <option value="">Выберите причину</option>
                          <option value="general">Общее впечатление о школе</option>
                          <option value="instructor">Качество обучения инструкторов</option>
                          <option value="administration">Работа администрации</option>
                          <option value="facilities">Состояние учебных помещений</option>
                          <option value="vehicles">Учебные автомобили</option>
                          <option value="pricing">Цены и условия оплаты</option>
